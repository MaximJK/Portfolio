       ...
       <p>
         recent projects:
          ...
          <div>
            ...
            <a href="https://github.com/MaximJK/Op." className="link" target="_blank"> <img src={op} className={projectsStyles.op}></img></a>
   <p className={projectsStyles.title}>Op.</p>
   current project | <a href="https://github.com/MaximJK/Op." className="link" target="_blank"> git</a>  
   <p>Social art production platform built on Django/React.</p>
   <br></br>
   </div>
   <div className={projectsStyles.projectBox}>
   <a href="https://maximjk.github.io/Sema/" className="link" target="_blank"><img src={sema} className={projectsStyles.sema}></img></a>
    ...
    <div className={projectsStyles.projectBox}>
    <a href="https://openbook-aa.herokuapp.com/#/" className="link" target="_blank"><img src={openbook} className={projectsStyles.openbook}></img></a>
